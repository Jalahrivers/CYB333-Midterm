# CYB33-Midterm Socket Connection and Port Scanner
...
- Includes input validation, error handling, and timestamps.
- Allowed targets: localhost (127.0.0.1) and scanme.nmap.org.
